...
import { Button, buttonVariants } from '@/shad/components/ui/button'
...
} from '@/shad/components/ui/range-calendar'
...
<template>
  <Popover>
    <PopoverTrigger as-child>
      <Button variant="outline" :disabled="!isCalendarEnabled" :class="cn(
