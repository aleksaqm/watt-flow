    ...
    <form class="w-full space-y-6" @submit="onSubmit">
        <FormField class="pt-2" name="images">
          <FormItem style="position: relative;">
            ...
            <FormControl>
              <input type="file" @change="e => onFileChange(e, 'images')" accept="image/*" multiple />
            </FormControl>
            <FormMessage class="absolute -bottom-5 left-0 text-xs" v-if="errors.images">{{ errors.images
              }}</FormMessage>
          </FormItem>
