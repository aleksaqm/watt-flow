...
export const authGuard: NavigationGuard = async (to, from, next) => {
  ...
  const authMap = {
    ...
    "Regular": ['/profile', '/home', '/my-property-request', '/property-request', '/household/search', '/ownership/requests', '/meeting/user', '/meeting/schedule', '/bills/owner', '/bills/pay/:billId', '/bills/pay/success']
  };
